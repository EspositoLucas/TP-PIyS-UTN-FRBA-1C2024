...
# Cargar los datasets
tesla_data_2 = pd.read_csv('dataset/2025/acciones_nasdaq_tesla_normalizados_2025.csv')
toyota_data_2 = pd.read_csv('dataset/2025/acciones_nasdaq_toyota_normalizados_2025.csv')
...
# Guardar las series estacionarias en archivos CSV
tesla_data_2_detrended_df.to_csv('dataset/2025/acciones_tesla_estacionaria_2025.csv', index=False)
toyota_data_2_detrended_df.to_csv('dataset/2025/acciones_toyota_estacionaria_2025.csv', index=False)
